...
exports.init = function(options, cb) {
  var _self = this;
  var iconsYaml = fs.readFileSync(pathModule.join('.', 'Font-Awesome/src/icons.yml'), {encoding: 'utf8'});
  var fontData = fs.readFileSync(pathModule.join('.', 'Font-Awesome/fonts/fontawesome-webfont.svg'), {encoding: 'utf8'});
